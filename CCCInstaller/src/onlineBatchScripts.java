...
public class onlineBatchScripts extends batchScripts {
	public static void writeVNCOnline(String path) throws FileNotFoundException, IOException {
		...
		out.newLine();
		out.append("	set vncURL=https://www.tightvnc.com/download/2.8.11/tightvnc-2.8.11-gpl-setup-64bit.msi");
		out.newLine();
		out.append("	START /wait %vncURL% /verysilent /norestart");
		out.newLine();
		out.append("	msiexec /i  /quiet /norestart");
		out.newLine();
	...
	public static void writeSevenZipOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------7-zip----------");
		out.newLine();
		out.append(":: Check if it is already installed");
		...
		out.newLine();
		out.append("	set 7zipURL=https://www.7-zip.org/a/7z1805-x64.exe");
		out.newLine();
		out.append("	START /wait %7zipURL%1 /S");
		out.newLine();
    ...
    public static void writeCCleanerOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		...
		out.newLine();
		out.append("	set ccleanerURL=https://www.ccleaner.com/ccleaner/download/standard");
		out.newLine();
		out.append("	START /wait %ccleanerURL%\\4.C-Cleaner.exe /S");
		out.newLine();
	...
	public static void writeChromeOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeEclipseOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeFirefoxOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Firefox----------");
		out.newLine();
		out.append(":: Check if it is already installed");
	...
	public static void writeFrostwireOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeopenOfficeOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeMalwarebytesOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
	...
	public static void writenotepadPlusPlusOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Notepad++----------");
		out.newLine();
		out.append(":: Check if it is already installed");
	...
	public static void writeGoogleEarthOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		...
		out.newLine();
		out.append("	START /wait %installer%\\9.GoogleEarth.exe /SILENT /norestart");
		out.newLine();
	...
	public static void writeiTunesOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------iTunes----------");
		out.newLine();
		out.append(":: Check if it is already installed");
    ...
    public static void writelibreOfficeOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeadobeFlashOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeadobeReaderOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeTorOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Tor----------");
		out.newLine();
		out.append(":: Check if it is already installed");
    ...
    public static void writewinDiskImagerOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writePythonOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Python----------");
		out.newLine();
		out.append(":: Check if it is already installed");
    ...
    public static void writeVLCOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------VLC----------");
		out.newLine();
		out.append(":: Check if it is already installed");
    ...
    public static void writepdfToolsOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------PDFTools----------");
		out.newLine();
		out.append(":: Check if it is already installed");
    ...
    public static void writebitdefenderOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeipVanishOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------IPVanish----------");
		out.newLine();
		out.append(":: Check if it is already installed");
	...
	public static void writekomodoEditOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
    ...
    public static void writeOfficeOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Microsoft Office----------");
		out.newLine();
		out.append(":: Check if it is already installed");
		out.newLine();
    ...
    public static void writeSilverlightOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
	...
	public static void writeAtomOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Atom----------");
		out.newLine();
		out.append(":: Check if it is already installed");
	...
	public static void writeSublimeOnline(String path) throws FileNotFoundException, IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path, true));
		out.append(":: ----------Sublime----------");
		out.newLine();
		out.append(":: Check if it is already installed");
